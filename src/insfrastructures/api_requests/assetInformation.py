...
class AssetInformation(BaseRequest):
    ...
    def setParams(self, asset=None, recvWindow=5000, timestamp=getTimestamp()):
        self.params["asset"] = asset
